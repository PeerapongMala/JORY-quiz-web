...
const questions = [
  ...
  {
    id: 2,
    question: "ถ้าคนอยู่ใกล้คุณ เขาควรรู้สึกแบบไหน",
    options: [
      { value: "A", label: "A. สุภาพ นุ่ม มีเสน่ห์แบบเงียบ" },
      { value: "B", label: "B. ร่าเริง เป็นกันเอง สดใส ซุกซน" },
      { value: "C", label: "C. อบอุ่น เหมือนได้พักใจ" },
      { value: "D", label: "D. สบายใจ ไม่ต้องเกร็ง" },
      { value: "E", label: "E. สะอาด สดชื่น" },
    ],
  },
  {
    id: 3,
